...
const AuthLayout = () => {
  return (
    <div className="h-screen md:grid md:grid-cols-2 flex flex-col">
      ...
      <div className="flex-1 h-screen overflow-y-auto bg-gray-900 pt-24 md:pt-0 p-4 md:p-16">
        <div className="w-full max-w-md mx-auto bg-gray-800 rounded-2xl shadow-lg p-6 md:p-12">
          <Outlet />
        </div>
      </div>
